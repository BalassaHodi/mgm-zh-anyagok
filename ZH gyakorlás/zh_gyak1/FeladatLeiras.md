...
A mentés során ellenőrizze, hogy az előző ponttól minimum egy adott távolságra, a távolságot szintén paraméterként kérje be. (2 pont)
...
## Node2 pub_path
Készítsen egy node-t, mely be kér egy elérési utat paraméterként, ahol egy felvett útvonal tálálható. A benne lévő adatok mennyisége és minősége megegyezik az előző  feladatban foglaltakkal. Olvassa be a fájlt és a benne lévő pálya információt küldje ki a "/path" topicra nav_msgs/Path típusú üzenetként 1 Hz-es időzítéssel. (4 pont)
